              ...
              <v-card class="">
                ...
                <v-card-text class="pa-5 pt-0">
                  <v-row class="d-flex">
                    ...
                    <v-col cols="3"
                      ><span class="text-h3" v-text="contribuyentes"></span
                    ></v-col>
                  </v-row>
                </v-card-text>
              </v-card>
              ...
              <v-card class="">
                ...
                <v-card-text class="pa-5 pt-0">
                  <v-row class="d-flex">
                    ...
                    <v-col cols="3"
                      ><span class="text-h3" v-text="comprobante"></span
                    ></v-col>
                  </v-row>
                </v-card-text>
              </v-card>
  ...
  export default {
    ...
    created() {
      const fetchData = async () => {
        ...
        const {
          data: { count: contribuyentes },
        } = await axios.get('/contribuyentes/count');
        const {
          data: { count: comprobante },
        } = await axios.get('/comprobante/count');
