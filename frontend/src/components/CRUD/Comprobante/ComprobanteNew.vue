  ...
  <v-card class="mt-6 py-3">
    <form @submit.prevent="submitHandler">
      <div class="px-8">
        <v-row>
          <v-col cols="12">
            <h4 class="page-title">New Comprobante</h4>
          </v-col>
          ...
          <v-col cols="9">
            <v-radio-group v-model="tipoRegistro" row>
              ...
              <v-col cols="12" sm="4" md="4">
                <v-radio label="INGRESOS" value="INGRESOS"></v-radio>
              </v-col>

              <v-col cols="12" sm="4" md="4">
                <v-radio label="EGRESOS" value="EGRESOS"></v-radio>
              </v-col>
            </v-radio-group>
          </v-col>
          ...
          <v-col cols="9">
            <v-radio-group v-model="tipoIdentificacion" row>
              <v-col cols="12" sm="4" md="4">
                <v-radio label="RUC" value="RUC"></v-radio>
              </v-col>
              ...
              <v-col cols="12" sm="4" md="4">
                <v-radio label="PASAPORTE" value="PASAPORTE"></v-radio>
              </v-col>
              ...
              <v-col cols="12" sm="4" md="4">
                <v-radio label="SIN NOMBRE" value="SIN NOMBRE"></v-radio>
              </v-col>

              <v-col cols="12" sm="4" md="4">
                <v-radio label="DIPLOMÁTICO" value="DIPLOMÁTICO"></v-radio>
              </v-col>
          ...
          <v-col cols="3" class="d-flex align-center">
            <p class="fs-normal greyBold--text mb-0">
          ...
          <v-col cols="9">
            <v-radio-group v-model="condicion" row>
              <v-col cols="12" sm="4" md="4">
                <v-radio label="CONTADO" value="CONTADO"></v-radio>
              </v-col>
  ...
  export default {
    ...
    computed: {
      ...mapState({
        ...
        optionsContribuyente: (state) =>
          state.comprobanteForm.searchResultContribuyente,
      }),
    ...
    methods: {
      ...
      ...mapActions({
        ...
        newHandler: 'comprobanteForm/newHandler',
      }),
      async submitHandler() {
        const data = {
          ...
          gravado10: this.gravado10,

          gravado5: this.gravado5,
          ...
          imputaIVA: this.imputaIVA,

          imputaIRE: this.imputaIRE,

          imputaIRPRSP: this.imputaIRPRSP,
        ...
        const contribuyenteEl = this.optionsContribuyente.filter(
          (i) => i.label === this.contribuyente,
        );
        data.contribuyente = contribuyenteEl.length
          ? contribuyenteEl[0].id
          : null;
      ...
      resetData() {
        ...
        this.monedaExtranjera = false;

        this.imputaIVA = false;

        this.imputaIRE = false;

        this.imputaIRPRSP = false;
